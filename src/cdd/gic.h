...
#define GIC_DIST_BASE 0xF9000000 // DT_REG_ADDR_BY_IDX(DT_INST(0, arm_gic), 0)
#define GIC_CPU_BASE 0xF9001000	 // DT_REG_ADDR_BY_IDX(DT_INST(0, arm_gic), 1)

// #define GIC_DIST_BASE	0xf9020000 // DT_REG_ADDR_BY_IDX(DT_INST(0, arm_gic), 0)
// #define GIC_CPU_BASE	0xF9021000 // DT_REG_ADDR_BY_IDX(DT_INST(0, arm_gic), 1)

// #define CONFIG_MP_NUM_CPUS 		6
...
#define GICD_SGIR_TGTFILT_CPULIST GICD_SGIR_TGTFILT(0x00)
#define GICD_SGIR_TGTFILT_ALLBUTREQ GICD_SGIR_TGTFILT(0x01)
#define GICD_SGIR_TGTFILT_REQONLY GICD_SGIR_TGTFILT(0x02)
